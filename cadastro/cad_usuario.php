<?php
    ...
    include_once('cadastrar_user.php');
...
<?php while ($tabela = mysqli_fetch_assoc($resultado)) { ?>
  <form method="POST" action="processa_user.php">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Nome" name="<?php
...
<?php while ($tabela = mysqli_fetch_assoc($resultado)) { ?>
  <form method="POST" action="processa_user.php">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Nome do produto" name="nome_usuario" value="<?php echo $tabela['nome_usuario']?>">
    </div>
    <div class="form-group">
      <label for="exampleFormControlSelect1">Nome</label>
      <!-- <select class="form-control" id="exampleFormControlSelect1" name="quantidade" value="<?php echo $tabela['login']?>">
        <option>1</option>
        <option>2</option>
        <option>3</option>
        <option>4</option>
      ...
      <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" name="login" value="<?php echo $tabela['login']?>">
    </div>
    <div class="form-group">
    <label for="exampleFormControlInput1">Senha</label>
    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" name="senha" value="<?php echo $tabela['senha']?>">
    </div>
    <br>
  ...
  <?php } ?>
  <br>
  <a href="painel2.php" class="btn btn-primary">ver todos pedidos</a>
...
" value="<?php echo $tabela['nome_produto']?>">
    </div>
    <div class="form-group">
      <label for="exampleFormControlSelect1">Nome</label>
